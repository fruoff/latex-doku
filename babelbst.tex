...
\def\bblvolume{volume}          \def\bblvol{Band}
\def\bblof{of}
\def\bblnumber{number}          \def\bblno{no.}
\def\bblin{in}
\def\bblpages{pages}            \def\bblpp{S.}
...
\def\bblth{th}
\def\bbljan{Jan.}  \def\bblfeb{Feb.}  \def\bblmar{Mär.}
\def\bblapr{Apr.}    \def\bblmay{Mai}       \def\bbljun{Jun.}
\def\bbljul{Jul.}     \def\bblaug{Aug.}    \def\bblsep{Sep.}
